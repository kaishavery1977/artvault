...
android {
    ...
    buildTypes {
        // Debug builds always use the debug key: a debuggable APK must never
        // be signed with the release keystore, or a leaked debug build could
        // be installed in place of a release install and debugged against
        // the live app data.
        debug {}
        release {

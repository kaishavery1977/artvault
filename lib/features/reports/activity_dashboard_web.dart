          ...
          child: SizedBox(
            ...
            child: BarChart(
              BarChartData(
                ...
                maxY: (monthlyCounts.values.isEmpty ? 1 : monthlyCounts.values.reduce((a, b) => a > b ? a : b)) * 1.2,
                  ...
                  bottomTitles: AxisTitles(
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        ...
                        return Text(keys[idx], style: TextStyle(fontSize: 9, color: scheme.onSurfaceVariant.withValues(alpha: 0.5)));
                      },
                    ),
                  ),
                ),
                ...
                barGroups: monthlyCounts.entries.toList().asMap().entries.map((entry) {
                  ...
                  return BarChartGroupData(
                    ...
                    barRods: [
                      BarChartRodData(
                        toY: count.toDouble(),
                        color: AppColors.accent.withValues(alpha: count > 0 ? 0.8 : 0.15),
                        width: 14,
                        borderRadius: const BorderRadius.vertical(top: Radius.circular(4)),
                        backDrawRodData: BackgroundBarChartRodData(
                          show: true,
                          toY: (monthlyCounts.values.isEmpty ? 1 : monthlyCounts.values.reduce((a, b) => a > b ? a : b)) * 1.2,
              ...
              child: _DashboardCard(
                ...
                child: Column(
                  children: mediumCounts.entries.take(5).map((e) {
                    final fraction = paintings.isNotEmpty ? e.value / paintings.length : 0.0;
                    final colors = [AppColors.violet500, AppColors.cyan500, AppColors.rose500, AppColors.amber500, AppColors.emerald500];
                    final color = colors[mediumCounts.entries.toList().indexOf(e) % colors.length];
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            flex: 3,
                            child: Text(e.key, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500), maxLines: 1, overflow: TextOverflow.ellipsis),
                          ),
                          Expanded(
                            flex: 5,
                            child: ClipRRect(
              ...
              child: _DashboardCard(
                ...
                child: Column(
                  children: topArtists.take(5).map((e) {
                    final colors = [AppColors.accent, AppColors.cyan400, AppColors.rose400, AppColors.amber400, AppColors.emerald400];
                    ...
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(child: Text(e.key, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w500), maxLines: 1, overflow: TextOverflow.ellipsis)),
                          Text('${e.value}', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: color)),
                        ],
                      ),
                    );
                  }).toList(),
